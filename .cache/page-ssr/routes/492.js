...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2178) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4803) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(4803).concat)(__webpack_require__(5169)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(4803).concat)(__webpack_require__(5169)) },
        gb18030: function() { return __webpack_require__(7344) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8545) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(7203) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(7203).concat)(__webpack_require__(1722)) },
        encodeSkipVals: [
...
var iconvLite = __webpack_require__(7036);
...
var http = _interopDefault(__webpack_require__(7945));
...
let convert;
try {
	convert = (__webpack_require__(3211)/* .convert */ .C);
} catch (e) {}
...
var StringDecoder = (__webpack_require__(3318).StringDecoder);
...
var buffer = __webpack_require__(1158)
...
var modules = [
    ...
    __webpack_require__(4431),
    __webpack_require__(5537),
    __webpack_require__(9507),
    __webpack_require__(4199),
...
var bomHandling = __webpack_require__(4146),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(5641); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(9873)(stream_module);
...
var stream_module;
try {
    stream_module = __webpack_require__(6272);
} catch (e) {}
